...
#3set_property IOSTANDARD LVCMOS33 [get_ports clock]
...
## LEDs
#set_property PACKAGE_PIN U16 [get_ports {G1}]
...
#set_property PACKAGE_PIN V3 [get_ports {Y2}]
#set_property IOSTANDARD LVCMOS33 [get_ports {Y2}]
#set_property PACKAGE_PIN W3 [get_ports {R2]}]
